...
-- Question 1 
-- SQL query to get the firstName, lastName, email, and officeCode of all employees.
-- Using an INNER JOIN to combine the employees table with the offices table using the officeCode column
SELECT e.firstName,
       e.lastName,
       e.email,
       e.officeCode
...
-- Using a RIGHT JOIN to combine the customers table with the orders table using the customerNumber column.
SELECT o.orderDate,
       o.shippedDate,
       o.status,
       o.customerNumber
